...
export function ProfileSuccessModal({ isOpen, onClose }: ProfileSuccessModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] border-0 bg-transparent shadow-none">
        ...
        >
          ...
          <h2 className="text-xl font-semibold mb-2">Changes saved successfully</h2>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
          >
            <div className="absolute top-4 left-4 w-2 h-2 bg-red-400 rounded-full" />
